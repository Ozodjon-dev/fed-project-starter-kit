...
return [
    ...
    "Report" => "Отчёт",
    "Memorial order" => "Мемориальный ордер",
    "Memorial order-6" => "6 - Мемориальный ордер (Нак. вед. по расчетам с прочими орг.)",
    "Memorial order-2" => "2 - Мемориальный ордер (Нак. вед. по движению бюджетных средств)",
