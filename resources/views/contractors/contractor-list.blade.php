    ...
    <div class="table-responsive rounded container-fluid" style="font-size: small">
        <table class="table table table-bordered table-sm" style="text-align: center">
            ...
            <tr class="align-middle align-content-center">
                ...
                <th scope="col">Расчетный счет-1</th>
                <th scope="col">Расчетный счет-2</th>
                <th scope="col">Расчетный счет-3</th>
                <th scope="col">Расчетный счет-4</th>
                <th scope="col"></th>
            </tr>
            </thead>
            <tbody>
            <tr>
                <th>1</th>
                <td>O`zbekiston Respublikasi Iqtisodiyot va moliya vazirligi</td>
                <td>201122919</td>
                <td>00014</td>
