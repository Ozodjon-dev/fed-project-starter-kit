        ...
        @else
            <nav
                ...
                <div class="navbar-container d-flex content">
                    <div class="bookmark-wrapper d-flex align-items-center">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            </li><strong class="alert alert-warning text-center" style="max-width: 200px; margin-bottom: 0;">⚠ Внимание! Данный проект работает в режиме
                                тестирования. ⚠</strong>
                        </ul>
                    </div>
                ...
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button type="submit" class="d-flex btn btn-danger me-1">
                        Выйти<i data-feather="log-out" class="ms-1"></i>
                    </button>
                </form>
