...
@section('content')
    <section class="invoice-add-wrapper">
        <form class="needs-validation" action="{{ route('receipt_of_funds.update', $receipt_of_fund->id) }}"
              method="post">
            @csrf
            @method('patch')
                        ...
                        <div class="card-body invoice-padding">
                            <div class="d-flex flex-wrap justify-content-center">
                                    ...
                                    <div class="d-flex align-items-center mb-1" style="max-width: 1200px">
                                        ...
                                        <div style="min-width: 450px">
                                            <select name="bank_account"
                                                ...
                                                <option value="{{ $receipt_of_fund->bank_account }}"
                                                        selected>{{ $receipt_of_fund->bank_account }}</option>
                                ...
                                <div class="d-flex align-items-center mb-1 w-100">
                                    ...
                                    <select class="form-select rounded w-100" name="debit_chart_of_account"
                                        ...
                                        <option value="{{ $receipt_of_fund->debit_chart_of_account }}"
                                                selected>{{ $receipt_of_fund->debit_chart_of_account }}</option>
                                ...
                                <div class="d-flex align-items-center mb-1 w-100">
                                    ...
                                    <select class="form-select rounded w-100" name="credit_chart_of_account"
                                        ...
                                        <option value="{{ $receipt_of_fund->credit_chart_of_account }}"
                                                selected>{{ $receipt_of_fund->credit_chart_of_account }}</option>
                                        @foreach($chart_of_accounts as $chart_of_account)
                                            <option value="{{ $chart_of_account->number }}"
                                                    data-number="{{ $chart_of_account->number }}">
                                                {{ $chart_of_account->number }} - {{ $chart_of_account->name }}
                                    ...
                                    <select class="form-select rounded w-100" name="contract_id"
                                        ...
                                        @foreach($contracts as $contract)
                                            <option value="{{ $contract->id }}"
                                                ...
                                                {{ $receipt_of_fund->contract_id == $contract->id ? 'selected' : '' }}>
                                ...
                                <div class="d-flex align-items-center mb-1 w-100">
                                    ...
                                    <select class="form-select mb-75 rounded" name="article" id="article">
                                        <option value="{{ $receipt_of_fund->article }}" selected>{{ $receipt_of_fund->article }}</option>
                                ...
                                <div class="d-flex align-items-center mb-1 w-100">
                                    ...
                                    <textarea name="details" id="details"
                                              class="form-control rounded w-100" required>{{ $receipt_of_fund->details }}</textarea>
                                </div>
                            </div>
                            <div class="d-flex flex-wrap w-100 mb-1">
                                <div class="d-flex align-items-center mb-1 w-100 w-md-auto">
                                    ...
                                    <div class="col-xl-4">
                                        <input type="text"
                                               value="{{ number_format($receipt_of_fund->amount, 2, '.', ',') }}"
                ...
                <div class="col-xl-3 col-md-4 col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{route('receipt_of_funds.list')}}" class="btn btn-outline-danger w-100">Отмена</a>
                        </div>
                    </div>
                </div>
            </div>
